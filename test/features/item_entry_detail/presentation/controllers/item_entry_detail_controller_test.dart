...
void main() {
  group('ItemEntryDetailController', () {
    late AppDatabase db;
    ...
    group('deleteItem', () {
      test(
        'should soft delete an existing item and update state to AsyncData',
        () async {
          const itemId = 'f1e2d3c4-b5a6-7890-fedc-ba0987654321';
          ...
          final state = container.read(itemEntryDetailControllerProvider);
